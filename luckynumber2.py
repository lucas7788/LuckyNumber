...
def getPaperBalance(account):
    currentRound = getCurrentRound()
    blankPaperBalance = Get(GetContext(), concatKey(PAPER_BALANCE_PREFIX, account))
    filledPaperBalance = getFilledPaperBalance(account, currentRound)
    return Add(blankPaperBalance, filledPaperBalance)
